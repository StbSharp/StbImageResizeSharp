// Generated by Sichem at 2/13/2021 9:28:10 PM
...
namespace StbImageResizeSharp
{
	unsafe partial class StbImageResize
	{
		...
		public static float stbir__max_uint8_as_float = 255.0f;
		public static float stbir__max_uint16_as_float = 65535.0f;
		public static double stbir__max_uint32_as_float = 4294967295.0;
		...
		public static int stbir__resize_arbitrary(void* input_data, int input_w, int input_h,
			...
			int type, int h_filter, int v_filter, int edge_horizontal, int edge_vertical, int colorspace)
		{
			...
			int num_channels, int alpha_channel, int flags, int edge_wrap_mode, int filter, int space)
		{
			return stbir__resize_arbitrary(input_pixels, input_w, input_h, input_stride_in_bytes,
				output_pixels, output_w, output_h, output_stride_in_bytes, 0, 0, 1, 1, null, num_channels,
				alpha_channel, (uint)flags, STBIR_TYPE_UINT8, filter, filter, edge_wrap_mode, edge_wrap_mode, space);
		}
			...
			int num_channels, int alpha_channel, int flags, int edge_wrap_mode, int filter, int space)
		{
			return stbir__resize_arbitrary(input_pixels, input_w, input_h, input_stride_in_bytes,
				output_pixels, output_w, output_h, output_stride_in_bytes, 0, 0, 1, 1, null, num_channels,
				alpha_channel, (uint)flags, STBIR_TYPE_UINT16, filter, filter, edge_wrap_mode, edge_wrap_mode, space);
		}
			...
			int num_channels, int alpha_channel, int flags, int edge_wrap_mode, int filter, int space)
		{
			return stbir__resize_arbitrary(input_pixels, input_w, input_h, input_stride_in_bytes,
				output_pixels, output_w, output_h, output_stride_in_bytes, 0, 0, 1, 1, null, num_channels,
				alpha_channel, (uint)flags, STBIR_TYPE_FLOAT, filter, filter, edge_wrap_mode, edge_wrap_mode, space);
		}
			...
			int filter_vertical, int space)
		{
			return stbir__resize_arbitrary(input_pixels, input_w, input_h, input_stride_in_bytes,
				output_pixels, output_w, output_h, output_stride_in_bytes, 0, 0, 1, 1, null, num_channels,
				alpha_channel, (uint)flags, datatype, filter_horizontal, filter_vertical, edge_mode_horizontal,
		...
		public static int stbir_resize_subpixel(void* input_pixels, int input_w, int input_h, int input_stride_in_bytes,
			void* output_pixels, int output_w, int output_h, int output_stride_in_bytes, int datatype, int num_channels,
			int alpha_channel, int flags, int edge_mode_horizontal, int edge_mode_vertical, int filter_horizontal,
			int filter_vertical, int space, float x_scale, float y_scale, float x_offset,
			float y_offset)
		{
			...
			return stbir__resize_arbitrary(input_pixels, input_w, input_h, input_stride_in_bytes,
				output_pixels, output_w, output_h, output_stride_in_bytes, 0, 0, 1, 1, transform, num_channels,
				alpha_channel, (uint)flags, datatype, filter_horizontal, filter_vertical, edge_mode_horizontal,
				edge_mode_vertical, space);
		}
		...
		{
			return stbir__resize_arbitrary(input_pixels, input_w, input_h, input_stride_in_bytes,
				output_pixels, output_w, output_h, output_stride_in_bytes, s0, t0, s1, t1, null, num_channels,
				alpha_channel, (uint)flags, datatype, filter_horizontal, filter_vertical, edge_mode_horizontal,
				edge_mode_vertical, space);
		}
	}
